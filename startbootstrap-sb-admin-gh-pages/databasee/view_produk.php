            ...
            <div id="layoutSidenav_content">
                ...
                <table class="table table-light table-striped">
                    <tbody>
                        ...
                        <tr>   <td>harga jual</td><td><?="Rp " . number_format($row ['purchase_price'], 2, ',', '.');?></td></tr>
                        <tr>   <td>harga beli</td><td><?="Rp " . number_format($row ['sell_price'], 2, ',', '.');?></td></tr>
                        <tr>   <td>stock</td><td><?=$row['stock']?></td></tr>
                        <tr>   <td>min stock</td><td><?=$row['min_stock']?></td></tr>
                        <tr>   <td>produk type id</td><td><?=$row['product_type_id']?></td></tr>
                    </tbody>
                </table>
