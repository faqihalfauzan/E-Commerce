            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                    <div class="jumbotron jumbotron-fluid" style="background-color:cream rgb(33,37,41); height: 150px; padding: 20px; margin: 10px;">
                        <div class="container" style="background: url(../img/banner/banner3.png); padding-bottom: 2px;  padding-top: 25px;">
                            <h1 class="mt-4 text-dark">Edit customer</h1>
                        </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="phone" name="phone" value="<?=$row['phone']?>" type="number" class="form-control">
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="address" name="address" value="<?=$row['address']?>" type="text" class="form-control">
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="card_id" name="card_id" value="<?=$row['card_id']?>" type="number" class="form-control">
                    </div>
                    </div>
                </div>
