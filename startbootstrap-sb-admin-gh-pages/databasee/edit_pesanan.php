                ...
                <div class="container-fluid px-4">
                    <div class="jumbotron jumbotron-fluid" style="background-color:cream rgb(33,37,41); height: 150px; padding: 20px; margin: 10px;">
                        <div class="container" style="background: url(../img/banner/banner3.png); padding-bottom: 2px;  padding-top: 25px;">
                            <h1 class="mt-4 text-dark">Edit pesanan</h1>
                        </div>
                </div>
                ...
                <form method="POST" action="proses_customer.php">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="input-group">
                            ...
                            <input id="date" name="date" type="text" class="form-control" value="">
                        </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="input-group">
                            ...
                            <input id="qty" name="qty" value="" type="number" class="form-control">
                        </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="input-group">
                            ...
                            <input id="total_price" name="total_price" value="" type="number" class="form-control">
                        </div>
                        </div>
                    </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="input-group">
                            ...
                            <input id="customer_id" name="customer_id" value="" type="text" class="form-control" placeholder="  ">
                        </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="input-group">
                            ...
                            <input id="product_id" name="product_id" value="" type="text" class="form-control" placeholder="Masukkan product_id">
                        </div>
                        </div>
                    </div>
                        ...
                        <?php 
                            ...
                            $id_jenis = $row["name"];
                            $query2 = "SELECT * FROM customer WHERE id = '$id_jenis'";
