...
<html lang="en">
    <head>
        ...
        <title>El Shop</title>
        <link rel="shortcut icon" href="../images/shopping-bag-icon.png" type="image/x-icon">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="../shopping/shopping.html" onclick="showLoginAlert()">
                ...
                <div class="container-fluid px-4">
                    <div class="jumbotron jumbotron-fluid" style="background-color: cream; height: 150px; padding: 20px; margin: 10px;">
                        <div class="container" style="padding-bottom: 2px;  padding-top: 25px;">
                            <h1 class="mt-4 text-black">Product Type</h1>
                        </div>
                </div>

                <a class="btn btn-success" href="form_merk.php" role="button">Create product</a><br><br>
