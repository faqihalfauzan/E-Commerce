                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="startbootstrap-sb-admin-gh-pages/index.php">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="name" name="name" type="number" class="form-control" value="<?=$row['name']?>">
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="purchase_price" name="purchase_price" value="<?=$row['purchase_price']?>" type="number" class="form-control">
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="sell_price" name="sell_price" value="<?=$row['sell_price']?>" type="number" class="form-control">
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="stock" name="stock" value="<?=$row['stock']?>" type="number" class="form-control">
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="min_stock" name="min_stock" value="<?=$row['min_stock']?>" type="number" class="form-control">
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <input id="product_type_id" name="product_type_id" value="<?=$row['product_type_id']?>" type="number" class="form-control">
                    </div>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="input-group">
                        ...
                        <?php 
                            ...
                            $id_jenis = $row["name"];
                            $query2 = "SELECT * FROM product WHERE id = '$id_jenis'";
