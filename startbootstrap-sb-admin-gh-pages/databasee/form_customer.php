                ...
                <div class="container-fluid px-4">
                    <div class="jumbotron jumbotron-fluid" style="background-color:cream rgb(33,37,41); height: 150px; padding: 20px; margin: 10px;">
                        <div class="container" style="background: url(../img/banner/banner3.png); padding-bottom: 2px;  padding-top: 25px;">
                            <h1 class="mt-4 text-dark">customer</h1>
                        </div>
                </div>
                <div class="container">
                <form method="POST" action="proses_customer.php">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="input-group">
                            ...
                            <input id="phone" name="phone" value="" type="number" class="form-control">
                        </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="input-group">
                            ...
                            <input id="email" name="email" value="" type="number" class="form-control">
                        </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="input-group">
                            ...
                            <input id="Address" name="Address" value="" type="text" class="form-control" placeholder="  ">
                        </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="input-group">
                            ...
                            <input id="card_id" name="card_id" value="" type="text" class="form-control" placeholder="Masukkan card_id">
                        </div>
                        </div>
                    </div>
