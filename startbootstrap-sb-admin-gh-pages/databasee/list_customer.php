...
<html lang="en">
    ...
    <body class="sb-nav-fixed" style="background-color:white;">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="../shopping/shopping.html"><h5>El Shop</h5></a>
            <!-- Sidebar Toggle-->
                ...
                <div class="container-fluid px-4">
                    <div class="jumbotron jumbotron-fluid" style="background-color: cream; height: 150px; padding: 20px; margin: 10px;">
                        <div class="container" style="background: url(../img/banner/banner3.png); padding-bottom: 2px;  padding-top: 25px;">
                            <h1 class="mt-4 text-black"> Add Customer</h1>
                        </div>
                </div>

                <a class="btn btn-success" href="form_customer.php" role="button">Add</a><br><br>
                        ...
                        { ?>
                            ...
                            <tr>
                                ...
                                <td class=>
                                    ...
                                    <a class="btn btn-success" href="edit_customer.php?idedit=<?=$row['id']?>">Edit</a>
                                    <a class="btn btn-danger" href="delete_customer.php?iddel=<?=$row['id']?>"
