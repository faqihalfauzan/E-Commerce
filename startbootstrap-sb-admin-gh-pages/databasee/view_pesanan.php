        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                    <div class="jumbotron jumbotron-fluid" style="background-color: cream; height: 150px; padding: 20px; margin: 10px;">
                        <div class="container" style="background: url(../img/banner/banner3.png); padding-bottom: 2px;  padding-top: 25px;">
                            <h1 class="mt-4 text-dark">View Pesanan</h1>
                        </div>
                </div>
                <?php
                    $id = $_GET['id'];
                ...
                <table class="table table-light table-striped">
                    <tbody>
                        <tr>   <td>order_number</td><td><?=$row['order_number']?></td></tr>
                        <tr>   <td>date</td><td><?=$row['date']?></td></tr>
                        <tr>   <td>qty</td><td><?=$row['qty']?></td></tr>
                        <tr>   <td>total_price</td><td><?=$row['total_price']?></td></tr>
                        <tr>   <td>customer_id</td><td><?=$row['customer_id']?></td></tr>
                        <tr>   <td>product_id</td><td><?=$row['product_id']?></td></tr>
                    </tbody>
                </table>
